...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	public static final String HOSPITALJ_TABLE = "hosp";
	public static final String HOSPITALJ_ID = "_id";
	public static final String HOSPITALJ_DAY = "day";
	public static final String HOSPITALJ_REASON = "reason";
	public static final String HOSPITALJ_NAMEHOSP = "namehosp";
	public static final String HOSPITALJ_NAMEPHY = "namephy";
	public static final String HOSPITALJ_VITAL = "vital";
	public static final String HOSPITALJ_RECOMMENDATION = "recommendation";
	public static final String HOSPITALJ_NURSES = "nurses";
	public static final String HOSPITALJ_DATE = "date";
	public static final String HOSPITALJ_CAREPLAN = "careplan";
